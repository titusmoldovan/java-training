...
import code._4_student_effort.ChallengeThree.PairOf2;
...
public class PairOf2Test {
  public static Map<Integer[], Integer> data = Map.ofEntries(
          ...
          entry(new Integer[]{0, -5, 1, 3, -1, 5, 2,-5,-5},2),
          entry(new Integer[]{5,-5,5,9,0,9,2},1)
  );

  @org.junit.Test
  public void test() {
    code._4_student_effort.ChallengeThree.PairOf2 PairOf2 = new PairOf2();

public class Studio {
    ...
    public static void main(String[] args){
        ...
        Film film3 = new Film(2018,"film cu actori fara premii3", new Actor[]{actorFaraPremii01, actorFaraPremii02, actorFaraPremii03});
        ...
        System.out.println("Studios in which plays the <<actor cu 2 oscaruri>> are: ");
        for(int i = 0; i < studioDatabase.length ; i++)
